...
const testimonials = [
  {
    ...
    content: "MatchSavoir m'a permis de trouver un formateur expert en développement web qui a complètement transformé ma compréhension du code. Les cours personnalisés ont fait toute la différence dans mon parcours académique.",
    rating: 5
  },
  {
    id: 2,
    ...
    content: "En tant que professionnel en reconversion, j'avais besoin d'une formation flexible et efficace. Grâce à MatchSavoir, j'ai trouvé un formateur qui s'est adapté à mon emploi du temps et à mes besoins spécifiques.",
    rating: 5
  },
  {
    id: 3,
    ...
    content: "Devenir formatrice sur MatchSavoir a été une excellente décision pour ma carrière. La plateforme me met en relation avec des apprenants motivés et gère toute la partie administrative, me permettant de me concentrer sur l'enseignement.",
    rating: 4
  }
];
    ...
    <section className="py-20 bg-background-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ce que disent nos utilisateurs</h2>
          <p className="text-white/60 max-w-2xl mx-auto">
            Découvrez les expériences de nos apprenants et formateurs qui ont transformé leur parcours éducatif grâce à MatchSavoir.
          </p>
        </div>
          ...
          >
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex flex-col items-center text-center md:items-start md:text-left">
                ...
                <h3 className="text-white font-semibold text-lg">{testimonials[activeIndex].name}</h3>
                <p className="text-white/60 text-sm mb-3">{testimonials[activeIndex].role}</p>
